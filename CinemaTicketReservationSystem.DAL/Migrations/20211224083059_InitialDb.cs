        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountriesString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GenresString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DirectorsString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ScreenwritersString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProducersString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActorsString = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatTypes_SessionSeatTypes_SessionSeatTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdditionalServices_SessionAdditionalServices_SessionAdditionalServiceId",
                        column: x => x.SessionAdditionalServiceId,
                        principalTable: "SessionAdditionalServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdditionalServices_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalServices_TicketId",
                table: "AdditionalServices",
                column: "TicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatTypes_SessionSeatTypeId",
                table: "SeatTypes",
